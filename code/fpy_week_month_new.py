from factory_template import FpyTemplateNew, CycletimeTemplate
from datetime import datetime, timedelta

class FpyWeekMonthNew(FpyTemplateNew, CycletimeTemplate):
    def __init__(self):
        super(FpyWeekMonthNew, self).__init__()
...
if __name__=="__main__":
    fpy_week_month = FpyWeekMonthNew()
    shift_day = 1
