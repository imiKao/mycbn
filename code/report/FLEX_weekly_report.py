...
class FlexWeeklyReport(WeeklyReportTemplate):
    def __init__(self):
        super(FlexWeeklyReport, self).__init__()
    ...
    def main(self, factory_name, which_week, dashboard_id_info):
        ...
        """Lower CPK summary"""
        self.display_current_time("=== Step2: Lower CPK test item Summary dashboard ===")
...
if __name__=="__main__":
    get_report = FlexWeeklyReport()
    which_period = 1
    factory_list = ["FLEX"]
    dashboard_id_dict = {
            "summary": {"summary_page": "FFoW4cDMz"},
            "cpk_analysis": {"lower_cpk_summary": "QOknUQEMk",
                             "test_item": "yhIHUQPGk",
                             "normal_cpk_lower_accuracy": "CMCw0eEGz",
                             "higher_cpk": "aObPHvsGz"}
    }
    try:
