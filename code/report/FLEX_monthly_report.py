...
class FlexMonthlyReport(MonthlyReportTemplate):
    def __init__(self):
        super(FlexMonthlyReport, self).__init__()
    ...
    def main(self, factory_name, which_month, dashboard_id_info):
        ...
        """CPK Analysis"""
        self.display_current_time("===Step2: CPK analysis===")
...
if __name__=="__main__":
    month_report = FlexMonthlyReport()
    which_period = 1
    factory_list = ["FLEX"]
    dashboard_id_dict = {
            "summary": {"summary_page": "-yKrScvMk"},
            "cpk_analysis": {"lower_cpk_summary": "KLigB9EMk",
