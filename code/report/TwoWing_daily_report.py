...
class TwoWingDailyReport(DailyReportTemplate):
    def __init__(self):
        super(TwoWingDailyReport, self).__init__()
    ...
    def main(self, factory_name, which_day, dashboard_id_info):
        ...
        self.save_file_name = '%s_TwoWing_daily_report'%(yesterday)
...
if __name__=="__main__":
    month_report = TwoWingDailyReport()
    which_period = 1
    factory_list = ["TwoWing"]
    dashboard_id_dict = {
            "summary": {"summary_page1": "iUeyK9HGz",
                        "summary_page2": "FpKoik_Gk"},
            "cpk_analysis": {"test_item": "6DjTZzLMz",
                             "test_item_type": "ukd484LMz"}
    }
    try:
